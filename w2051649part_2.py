...
Progression_Outcome=[]#Create Lists
Pass=[]
Defer=[]
Fail=[]
...
while Prompt != "q":#This should be false to exit loop
    ...
    if passCredits == 120:
        ...
        print(ProgressionOutcome)
    print("")
    Progression_Outcome.append(ProgressionOutcome)
    while True:
...
print('''
part 2:''')
number_of_elements = len(Pass)
for num in range(number_of_elements):
        print(Progression_Outcome[num],end='')
        print(' - ',end='')
        print(Pass[num],end='')
        print(', ',end='')
        print(Defer[num],end='')
